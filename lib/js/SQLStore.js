...
function updateClub(name,dateCreation){
    ...
    myDB.transaction(
        function (transaction) {
			...
			console.log(name);
            var squery  = 'Update clubs SET name=? where name=?;';
            // alert('loading id' +id);
            transaction.executeSql(squery, [name,name],nullDataHandler,errorHandler);
            var squery  = 'Update clubs SET dateCreation=? where name=?;';
            // alert('loading id' +id);
            transaction.executeSql(squery, [dateCreation,name],nullDataHandler,errorHandler);
